											...
											<fieldset>
												<div class="row">
													<div class="col-md-6">
														<div class="form-group">
															...
															<form:input path="name" maxlength="120" type="text" class="form-control" id="name" name="name" />
														</div>
													</div>
												...
												<div class="row">
													...
													<div class="col-md-3 form-group">
														<label class="label-control" for="currency">Moeda:</label> <select class="form-control" name="currency" id="currency">
															<option value="BRL">Real Brasileiro R$</option>
															<option value="PYG">Paraguai Guarani ₲</option>
														</select>
													</div>
													<div class="col-md-6">
														<fieldset>
