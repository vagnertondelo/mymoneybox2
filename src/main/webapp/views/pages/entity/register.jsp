								...
								<div class="card-content collapse show">
									<div class="card-body">
										...
										<form class="form" id="${formId}">
											<div class="form-body">
												<div class="row">
													<input type="hidden" id="item-id" /> <input type="hidden" name="ipAddress" id="ipAddress" value="${ipAddress}" />
													<div class="col-md-6 form-group">
														<label class="label-control" for="entityCode">Entidade:</label> <select class="select2 form-control required" name="entityCode" id="entityCode">
													...
													<div class="col-md-6">
														<div class="form-group">
															<label class="label-control" for="pcEntity">Percentual:</label> <input type="text" id="pcEntity" max="100" class="form-control required" name="pcEntity" placeholder="%">
														</div>
													</div>
												</div>
											</div>
											<div class="table-responsive">
												<table class="table table-striped table-bordered" id="${tableId}" style="width: 100%">
												</table>
											</div>
											<div class="form-actions center">
												<button type="button" id="save-button" class="btn btn-outline-success btn-min-width btn-glow mr-1 mb-1">
