...
<div class="main-menu menu-accordion menu-shadow menu-fixed expanded menu-light" data-scroll-to-active="true">
	<div class="main-menu-content">
		<ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
			...
			<li class=" nav-item"><a href="${pageContext.request.contextPath}/accredited/register"><i class="ft-user-plus"></i><span class="menu-title" data-i18n="nav.dash.main">Credenciado</span></a>
			<li class=" nav-item"><a href="${pageContext.request.contextPath}/partner/register"><i class="ft-users"></i><span class="menu-title" data-i18n="nav.dash.main">Parceiro</span></a>
